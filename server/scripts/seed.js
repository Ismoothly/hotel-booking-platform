...
const getHotelsData = (merchantIds) => [
  ...
  {
    nameCn: '上海陆家嘴金融城酒店',
    nameEn: 'Shanghai Lujiazui Financial City Hotel',
    address: '上海市浦东新区银城中路188号',
    city: '上海',
    starRating: 5,
    openingDate: new Date('2021-09-01'),
    images: ['https://images.unsplash.com/photo-1542314831-068cd1dbfeeb'],
    rooms: [
      { type: '江景大床房', price: 1188, description: '42平米，黄浦江景', quantity: 22 },
      { type: '行政套房', price: 1988, description: '72平米，独立会客区', quantity: 10 }
    ],
    facilities: ['免费WiFi', '健身房', '泳池', '行政酒廊', '会议室'],
    nearbyAttractions: ['东方明珠', '上海中心', '滨江大道'],
    transportation: '地铁2号线陆家嘴站步行6分钟',
    nearbyShopping: ['国金中心', '正大广场'],
    discounts: [{ type: '连住优惠', description: '连住3晚享88折', percentage: 12 }],
    description: '陆家嘴核心商务区高端酒店，适合商务与城市观景',
    phone: '021-5066-8888',
    email: 'info@lujiazuihotel.com',
    website: 'https://www.lujiazuihotel.com',
    status: 'published',
    reviewStatus: 'approved',
    averageRating: 4.7,
    totalReviews: 538,
  ...
  {
    nameCn: '上海徐家汇商圈酒店',
    nameEn: 'Shanghai Xujiahui Business District Hotel',
    address: '上海市徐汇区虹桥路333号',
    city: '上海',
    starRating: 4,
    openingDate: new Date('2019-10-18'),
    images: ['https://images.unsplash.com/photo-1590490360182-c33d57733427'],
    rooms: [
      { type: '商务大床房', price: 558, description: '30平米，办公桌', quantity: 32 },
      { type: '家庭双床房', price: 628, description: '34平米，亲子友好', quantity: 16 }
    ],
    facilities: ['免费WiFi', '自助早餐', '健身房', '会议室'],
    nearbyAttractions: ['徐家汇天主教堂', '徐家汇书院', '上海体育馆'],
    transportation: '地铁1/9/11号线徐家汇站步行4分钟',
    nearbyShopping: ['港汇恒隆广场', '美罗城'],
    discounts: [],
    description: '徐家汇商圈高性价比商务酒店，交通便利',
    phone: '021-6421-7788',
    email: 'info@xujiahuihotel.com',
    website: 'https://www.xujiahuihotel.com',
    status: 'published',
    reviewStatus: 'approved',
    averageRating: 4.4,
    totalReviews: 361,
  ...
  {
    nameCn: '上海迪士尼度假区亲子酒店',
    nameEn: 'Shanghai Disney Resort Family Hotel',
    address: '上海市浦东新区申迪东路520号',
    city: '上海',
    starRating: 4,
    openingDate: new Date('2020-12-12'),
    images: ['https://images.unsplash.com/photo-1564501049412-61c2a3083791'],
    rooms: [
      { type: '亲子主题房', price: 768, description: '36平米，儿童主题布置', quantity: 26 },
      { type: '家庭套房', price: 1188, description: '58平米，两室一厅', quantity: 12 }
    ],
    facilities: ['免费WiFi', '儿童乐园', '接驳巴士', '餐厅'],
    nearbyAttractions: ['上海迪士尼乐园', '迪士尼小镇'],
    transportation: '迪士尼地铁站接驳车约8分钟',
    nearbyShopping: ['迪士尼小镇'],
    discounts: [{ type: '乐园联票', description: '酒店+乐园套餐95折', percentage: 5 }],
    description: '面向亲子出游的度假酒店，靠近迪士尼园区',
    phone: '021-5810-5566',
    email: 'info@disneyfamilyhotel.com',
    website: 'https://www.disneyfamilyhotel.com',
    status: 'published',
    reviewStatus: 'approved',
    averageRating: 4.5,
    totalReviews: 427,
  ...
  {
    nameCn: '上海人民广场城市酒店',
    nameEn: 'Shanghai People\'s Square City Hotel',
    address: '上海市黄浦区西藏中路500号',
    city: '上海',
    starRating: 4,
    openingDate: new Date('2018-11-08'),
    images: ['https://images.unsplash.com/photo-1618773928121-c32242e63f39'],
    rooms: [
      { type: '城市景观房', price: 628, description: '32平米，市中心景观', quantity: 24 },
      { type: '商务双床房', price: 668, description: '34平米，双床', quantity: 18 }
    ],
    facilities: ['免费WiFi', '餐厅', '会议室', '健身房'],
    nearbyAttractions: ['人民广场', '上海博物馆', '南京路步行街'],
    transportation: '地铁1/2/8号线人民广场站步行5分钟',
    nearbyShopping: ['来福士广场', '新世界城'],
    discounts: [],
    description: '位于人民广场核心位置，出行和购物都便利',
    phone: '021-6328-8899',
    email: 'info@peoplessquarehotel.com',
    website: 'https://www.peoplessquarehotel.com',
    status: 'published',
    reviewStatus: 'approved',
    averageRating: 4.3,
    totalReviews: 512,
  ...
  {
    nameCn: '上海世博滨江轻奢酒店',
    nameEn: 'Shanghai Expo Riverside Boutique Hotel',
    address: '上海市浦东新区世博大道1200号',
    city: '上海',
    starRating: 4,
    openingDate: new Date('2022-04-20'),
    images: ['https://images.unsplash.com/photo-1582719478250-c89cae4dc85b'],
    rooms: [
      { type: '滨江大床房', price: 698, description: '33平米，江景', quantity: 20 },
      { type: '景观套房', price: 1088, description: '56平米，落地窗', quantity: 8 }
    ],
    facilities: ['免费WiFi', '咖啡吧', '健身房', '自助洗衣'],
    nearbyAttractions: ['世博文化公园', '梅赛德斯奔驰文化中心'],
    transportation: '地铁8号线中华艺术宫站步行7分钟',
    nearbyShopping: ['世博源'],
    discounts: [{ type: '周中特惠', description: '周一至周四入住享9折', percentage: 10 }],
    description: '滨江轻奢设计酒店，适合休闲与短途商务',
    phone: '021-6876-3366',
    email: 'info@exporiversidehotel.com',
    website: 'https://www.exporiversidehotel.com',
    status: 'published',
    reviewStatus: 'approved',
    averageRating: 4.4,
    totalReviews: 206,
  ...
  {
    nameCn: '上海五角场大学城酒店',
    nameEn: 'Shanghai Wujiaochang University Town Hotel',
    address: '上海市杨浦区邯郸路199号',
    city: '上海',
    starRating: 3,
    openingDate: new Date('2018-02-14'),
    images: ['https://images.unsplash.com/photo-1578683010236-d716f9a3f461'],
    rooms: [
      { type: '舒适大床房', price: 328, description: '24平米', quantity: 36 },
      { type: '舒适双床房', price: 358, description: '26平米', quantity: 30 }
    ],
    facilities: ['免费WiFi', '自助早餐', '24小时前台'],
    nearbyAttractions: ['复旦大学', '同济大学', '江湾体育场'],
    transportation: '地铁10号线五角场站步行6分钟',
    nearbyShopping: ['合生汇', '百联又一城'],
    discounts: [],
    description: '大学城商圈便捷型酒店，适合差旅与探校',
    phone: '021-5568-2233',
    email: 'info@wujiaochanghotel.com',
    website: 'https://www.wujiaochanghotel.com',
    status: 'published',
    reviewStatus: 'approved',
    averageRating: 4.1,
    totalReviews: 645,
  ...
  {
    nameCn: '嘉兴南湖国际商务酒店',
    nameEn: 'Jiaxing Nanhu International Business Hotel',
    address: '嘉兴市南湖区中环南路188号',
    city: '嘉兴',
    starRating: 4,
    openingDate: new Date('2021-06-18'),
    images: ['https://images.unsplash.com/photo-1566073771259-6a8506099945'],
    rooms: [
      { type: '商务大床房', price: 438, description: '30平米，办公区', quantity: 28 },
      { type: '行政双床房', price: 498, description: '33平米，双床', quantity: 20 }
    ],
    facilities: ['免费WiFi', '健身房', '会议室', '自助早餐'],
    nearbyAttractions: ['南湖景区', '月河历史街区'],
    transportation: '嘉兴南站车程约20分钟',
    nearbyShopping: ['八佰伴', '旭辉广场'],
    discounts: [{ type: '周末特惠', description: '周末入住享9折', percentage: 10 }],
    description: '临近南湖景区的商务型酒店，兼顾出行与休闲',
    phone: '0573-8266-8899',
    email: 'info@nanhubusinesshotel.com',
    website: 'https://www.nanhubusinesshotel.com',
    status: 'published',
    reviewStatus: 'approved',
    averageRating: 4.3,
    totalReviews: 216,
  ...
  {
    nameCn: '嘉兴乌镇水乡度假酒店',
    nameEn: 'Jiaxing Wuzhen Water Town Resort Hotel',
    address: '嘉兴市桐乡市乌镇西栅景区旁',
    city: '嘉兴',
    starRating: 5,
    openingDate: new Date('2020-10-01'),
    images: ['https://images.unsplash.com/photo-1542314831-068cd1dbfeeb'],
    rooms: [
      { type: '水景大床房', price: 988, description: '42平米，临水阳台', quantity: 18 },
      { type: '庭院套房', price: 1588, description: '70平米，独立庭院', quantity: 8 }
    ],
    facilities: ['免费WiFi', '泳池', '中餐厅', '茶室', '接驳车'],
    nearbyAttractions: ['乌镇西栅', '乌镇东栅', '木心美术馆'],
    transportation: '桐乡高铁站接驳约25分钟',
    nearbyShopping: ['乌镇景区商业街'],
    discounts: [],
    description: '乌镇景区周边高端度假酒店，主打江南水乡体验',
    phone: '0573-8899-6688',
    email: 'info@wuzhenresorthotel.com',
    website: 'https://www.wuzhenresorthotel.com',
    status: 'published',
    reviewStatus: 'approved',
    averageRating: 4.7,
    totalReviews: 304,
