...
cartSchema.statics.addItem = async function(userId, itemData) {
  const { hotelId, hotelName, roomType, price, quantity, checkInDate, checkOutDate, nights } = itemData;
  ...
  const existingItem = cart.items.find(
    item => item.hotelId.toString() === hotelId.toString() && 
  ...
  if (existingItem) {
    ...
    existingItem.subtotal = existingItem.price * existingItem.quantity * existingItem.nights;
  } else {
