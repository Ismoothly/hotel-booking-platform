...
- 贾志强  后端架构及四端联调，并发机制设计、mongodb数据库数据持久化，Access Token + Refresh Token 双 Token 机制
- 邓丁熙  技术路线设计与规划，管理端功能优化（图片上传，房型选择），基于SSE的实时价格更新机制，分页与筛选功能
- 吴宇薇  小程序UI设计及重构，日历组件，折扣活动设计与实现，骨架屏优化